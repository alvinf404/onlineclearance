					...
					<div class="row">
						<div class="col-md-12" style="margin-left:10px">
							...
							<div class="row">
								...
								<ol>
									<?php
									$sql = "SELECT * FROM requirement NATURAL JOIN designee WHERE designee_id = 2";
									$query = $conn->prepare($sql);
									$query->execute();
									$fetch = $query->fetchAll();
								...
								if(isset($_POST['files']))
								{
									...
									if($sql1){ 													
										echo '
										<script> 														
											window.location = "supply_officer.php"
										</script>'; 												
									}
								}
								?>
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										NATURAL JOIN requirement WHERE designee_id = 2 AND id = $userid ";
										$query = $conn->prepare($sql);
										$query->execute();
										$fetch = $query->fetchAll();
